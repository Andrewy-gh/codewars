...
function outed(meeting, boss) {
  let total = 0;
  Object.entries(meeting).forEach(([key, value]) => {
    if (key === boss) total += value * 2
    else total += value
  })
  const average = total / Object.keys(meeting).length
...
console.log(outed({"tim":5,"jim":9,"randy":4,"sandy":1,"andy":3,"katie":6,"laura":8,"saajid":2,"alex":5,"john":0,"mr":2} , "katie")) // 'Get Out Now!'